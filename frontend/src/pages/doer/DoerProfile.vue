...
function submitPasswordChange() {
  ...
  if (!passwordNew.value) passwordErrors.value.new = t('profile.validation.required')
    ...
    passwordErrors.value.new = t('profile.validation.min8Chars')
  if (passwordNew.value !== passwordConfirm.value)
    passwordErrors.value.confirm = t('profile.validation.mismatch')
    ...
    <div class="space-y-3">
      <div class="flex items-center gap-3">
        ...
        <div class="flex-1">
          ...
          <p
            v-if="contactErrors.mobile"
            id="error-mobile"
            class="text-caption text-danger-600 mt-0.5"
          >
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex-1">
          ...
          />
          <p v-else class="text-body text-neutral-900">
            {{ employee.email || $t('profile.notSet') }}
          </p>
          <p
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex rounded-lg border border-neutral-200 overflow-hidden">
          <button
            ...
            :class="
              language === l ? 'bg-brand-600 text-white' : 'text-neutral-600 hover:bg-neutral-50'
            "
            @click="setLang(l)"
          >
            {{
      ...
      <div class="ml-8 space-y-2">
        <label class="flex items-center justify-between py-1.5 cursor-pointer">
          ...
          <input
            ...
            @change="
              store.setNotificationPref('tasks', ($event.target as HTMLInputElement).checked)
            "
          />
        </label>
        <label class="flex items-center justify-between py-1.5 cursor-pointer">
          ...
          <input
            ...
            class="h-4 w-4 rounded border-neutral-300 text-brand-600 focus:ring-brand-600"
            @change="
              store.setNotificationPref('leave', ($event.target as HTMLInputElement).checked)
            "
          />
        </label>
        <label class="flex items-center justify-between py-1.5 cursor-pointer">
          ...
          <input
            ...
            class="h-4 w-4 rounded border-neutral-300 text-brand-600 focus:ring-brand-600"
            @change="
              store.setNotificationPref('training', ($event.target as HTMLInputElement).checked)
            "
          />
        </label>
        <label class="flex items-center justify-between py-1.5 cursor-pointer">
          ...
          <input
            ...
            class="h-4 w-4 rounded border-neutral-300 text-brand-600 focus:ring-brand-600"
            @change="
              store.setNotificationPref('tickets', ($event.target as HTMLInputElement).checked)
            "
          />
        </label>
      </div>
  ...
  <teleport to="body">
      ...
      >
        ...
        <form v-else class="p-4 space-y-3" @submit.prevent="submitPasswordChange">
          <div>
            ...
            />
            <p
              v-if="passwordErrors.old"
              id="error-password-old"
    ...
    >
      <div class="bg-white w-full max-w-xs mx-4 rounded-lg shadow-modal p-6 animate-scale-in">
        <p class="text-body-strong text-neutral-900 mb-2">
