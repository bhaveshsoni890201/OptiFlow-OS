...
const filteredTrainings = computed(() => {
  ...
  if (activeFilter.value === 'not_started') return list.filter((t) => t.status === 'not_started')
      ...
      >
        ...
        <div class="space-y-1 text-caption text-neutral-500">
          <div class="flex items-center gap-1.5">
            ...
            {{
              t.source === 'standalone'
                ? $t('training.types.standalone')
                : $t('training.types.fromWorklist')
            }}
          </div>
          <div class="flex items-center gap-1.5">
        ...
        <div class="p-4 sm:p-6 space-y-4">
          ...
          <div class="flex items-center gap-3 text-caption text-neutral-500">
            ...
            <span class="flex items-center gap-1"
              ><CalendarDaysIcon class="h-3.5 w-3.5" />
              {{
                $t('training.deadline', { date: formatDateShort(selectedTraining.deadline) })
              }}</span
            >
          </div>

          <div class="rounded-lg bg-neutral-50 border border-neutral-200 p-4 sm:p-6 min-h-[200px]">
            <OptTrainingViewer
          ...
          >
            ...
            <span class="font-semibold">{{
              $t('training.relatedToWorklist', { id: selectedTraining.worklist_item_id })
            }}</span>
          </div>
          ...
          >
            ...
            <span>{{
              $t('training.completedOn', {
                date: selectedTraining.completed_on
                  ? formatDateTime(selectedTraining.completed_on)
                  : '--',
              })
            }}</span>
          </div>
